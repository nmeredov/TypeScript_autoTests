import * as variable from '../../RBOW_UAT_API3_Games/DragonTiger/variables';
import * as body from '../../RBOW_UAT_API3_Games/DragonTiger/CancelledGame/body';
...
describe("Final Settlement - Checks if response status is successful", () => {
  ...
  beforeAll(async () => {
    ...
    console.log('Payout is:', variable.bet);
