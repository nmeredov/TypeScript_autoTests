...
import * as body from "../../RBOW_UAT_API3_Games/Holdem/PreliminarySettlementForOneOfTwoBets/body";
...
describe("Preliminary Settlement ", async () => {
  let testResponse: any;
  let data: any;
...
describe("Get balance request after preliminary settlement - Checks balance for table and if response status is successful balance", async () => {
  let testResponse: any;
  let currentBalance: number;
  let data: any;
