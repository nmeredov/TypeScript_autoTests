...
import * as body from '../../RBOW_UAT_API3_Games/BlackJack/cancelAfterFinancialDecisionBody';
...
describe("Get balance before cancel", () => {
  let testResponse: any;
  let currentBalance: number;
...
describe("Final Settlement - Checks if response status is successful", () => {
  ...
  beforeAll(async () => {
    ...
    data = testResponse.data;
    console.log('Resolution is: GameCancelled');
    console.log('Payout is:', (variable.bet1 * 28) + (variable.bet2 * 7));
