...
import * as body from '../../RBOW_UAT_API3_Games/BlackJack/lateBetCancellationBody';
...
describe("Get balance_for_table -  after preliminary settlement", () => {
  let testResponse: any;
  let currentBalance: number;
  let data: any;
...
describe("Get balance", () => {
  ...
  beforeAll(async () => {
    ...
    currentBalance = data.balances[0].amount;
    initialBalance = currentBalance + variable.bet1;
    expectedBalance = initialBalance - variable.bet1;
